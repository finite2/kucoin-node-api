...
/* 
  Get margin risk limits
  GET /api/v1/market/allTickers
  model = string (cross or isolated)
*/
User.getMarginRiskLimit = async function (model = "cross") {
  let endpoint = `/api/v1/risk/limit/strategy?marginModel=${model}`;
